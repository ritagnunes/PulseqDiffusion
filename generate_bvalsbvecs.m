function [ bvals, bvecs ] = generate_bvalsbvecs(bmax,Ndir,Nb0s,Nb,fsl_flag)
% [ bvals, bvecs ] = generate_bvalsbvecs(bmax,Ndir,Nb0s,Nb,fsl_flag)
...
% Nb0s - number of non-DWI volumes (optional - default 1)
...
elseif nargin>5
    disp('Only using the first 5 input variables, the remaining will be ignored.')
end
...
bvecs=cat(1,Nb0s*zeros(1,3),bvecs);
